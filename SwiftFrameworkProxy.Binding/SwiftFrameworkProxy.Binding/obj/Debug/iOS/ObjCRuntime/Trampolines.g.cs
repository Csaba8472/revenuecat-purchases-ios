...
namespace ObjCRuntime {
	...
	static partial class Trampolines {
		...
		[UnmanagedFunctionPointerAttribute (CallingConvention.Cdecl)]
		[UserDelegateType (typeof (global::System.Action<global::Binding.RCOfferings, NSError>))]
		...
		static internal class SDActionArity2V0 {
			...
			static unsafe void Invoke (IntPtr block, IntPtr arg1, IntPtr arg2) {
				var descriptor = (BlockLiteral *) block;
				var del = (global::System.Action<global::Binding.RCOfferings, NSError>) (descriptor->Target);
				if (del != null)
					del ( Runtime.GetNSObject<Binding.RCOfferings> (arg1),  Runtime.GetNSObject<NSError> (arg2));
			}
		...
		internal sealed class NIDActionArity2V0 : TrampolineBlockBase {
			...
			[Preserve (Conditional=true)]
			[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			public unsafe static global::System.Action<global::Binding.RCOfferings, NSError>? Create (IntPtr block)
			{
				if (block == IntPtr.Zero)
					return null;
				var del = (global::System.Action<global::Binding.RCOfferings, NSError>) GetExistingManagedDelegate (block);
				return del ?? new NIDActionArity2V0 ((BlockLiteral *) block).Invoke;
			}
			
			[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
			unsafe void Invoke (global::Binding.RCOfferings arg1, NSError arg2)
			{
