...
namespace Binding {
	...
	public unsafe partial class SwiftFrameworkProxy : NSObject {
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void GetOfferingsWithClosure ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity2V0))]global::System.Action<RCOfferings, NSError> closure)
		{
			if (closure == null)
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void MakePurchaseWithPackage (RCPackages package, string entitlementId, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<bool> closure)
		{
			var package__handle__ = package.GetNonNullHandle (nameof (package));
			if (entitlementId == null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (entitlementId));
			if (closure == null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (closure));
			var nsentitlementId = NSString.CreateNative (entitlementId);
			BlockLiteral *block_ptr_closure;
			BlockLiteral block_closure;
			block_closure = new BlockLiteral ();
			block_ptr_closure = &block_closure;
			...
			if (IsDirectBinding) {
				global::ApiDefinitions.Messaging.void_objc_msgSend_IntPtr_IntPtr_IntPtr (this.Handle, Selector.GetHandle ("makePurchaseWithPackage:entitlementId:closure:"), package__handle__, nsentitlementId, (IntPtr) block_ptr_closure);
			} else {
				global::ApiDefinitions.Messaging.void_objc_msgSendSuper_IntPtr_IntPtr_IntPtr (this.SuperHandle, Selector.GetHandle ("makePurchaseWithPackage:entitlementId:closure:"), package__handle__, nsentitlementId, (IntPtr) block_ptr_closure);
			}
			NSString.ReleaseNative (nsentitlementId);
			block_ptr_closure->CleanupBlock ();
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe virtual void RestorePurchaseWithEntitlementId (string entitlementId, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<bool> closure)
		{
			if (entitlementId == null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (entitlementId));
			if (closure == null)
			...
			if (IsDirectBinding) {
				global::ApiDefinitions.Messaging.void_objc_msgSend_IntPtr_IntPtr (this.Handle, Selector.GetHandle ("restorePurchaseWithEntitlementId:closure:"), nsentitlementId, (IntPtr) block_ptr_closure);
			} else {
				global::ApiDefinitions.Messaging.void_objc_msgSendSuper_IntPtr_IntPtr (this.SuperHandle, Selector.GetHandle ("restorePurchaseWithEntitlementId:closure:"), nsentitlementId, (IntPtr) block_ptr_closure);
			}
			NSString.ReleaseNative (nsentitlementId);
			block_ptr_closure->CleanupBlock ();
